...
import com.persistence.java.domain.RestErrorInfo;
...
public abstract class AbstractRestHandler implements ApplicationEventPublisherAware {
    ...
    public
    @ResponseBody
    void handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request, HttpServletResponse response) {
    }
